...
export function uploadFiles(
  ...
  options.imageCompressionPercent &&
    req.setRequestHeader('x-skycloud-image-compression-percent', options.imageCompressionPercent.toString());
  ...
  options.overrides_returnDomain && req.setRequestHeader('x-skycloud-domain', options.overrides_returnDomain);

  ephemeral.password && req.setRequestHeader('x-skycloud-password', ephemeral.password);
  ephemeral.filename && req.setRequestHeader('x-skycloud-filename', encodeURIComponent(ephemeral.filename));
