...
import { SkyCloudTheme, findTheme, themeComponents } from '@/lib/theme';
...
export default function Theming({
  ...
  if (!theme) {
    theme = findTheme('builtin:dark_blue') ?? (dark_blue as unknown as SkyCloudTheme); // back up theme if all else fails lol
  }
