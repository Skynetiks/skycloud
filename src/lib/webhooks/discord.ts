...
export function parseContent(
  ...
  return {
    ...
    avatarUrl:
      ...
      'https://raw.githubusercontent.com/diced/skycloud/9b60147e112ec5b70170500b85c75ea621f41d03/public/skycloud.png',
    username: (config.discord?.username ?? content.username) || 'SkyCloud',
