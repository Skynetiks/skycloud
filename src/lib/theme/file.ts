...
export async function readThemes(): Promise<SkyCloudTheme[]> {
  ...
  parsedThemes.push(
    handleOverrideColors(dark_gray as SkyCloudTheme),
    handleOverrideColors(light_gray as unknown as SkyCloudTheme),
    handleOverrideColors(black_dark as unknown as SkyCloudTheme),
    handleOverrideColors(light_blue as unknown as SkyCloudTheme),
    handleOverrideColors(dark_blue as unknown as SkyCloudTheme),
    handleOverrideColors(cat_frappe as unknown as SkyCloudTheme),
    handleOverrideColors(cat_latte as unknown as SkyCloudTheme),
    handleOverrideColors(cat_macchiato as unknown as SkyCloudTheme),
    handleOverrideColors(cat_mocha as unknown as SkyCloudTheme),
    handleOverrideColors(midnight_orange as unknown as SkyCloudTheme),
    handleOverrideColors(midnight_blue as unknown as SkyCloudTheme),
  );
...
export async function parseThemes(themes: string[]): Promise<SkyCloudTheme[]> {
  const parsedThemes = [];
...
export function handleOverrideColors(theme: SkyCloudTheme) {
  return {
    ...theme,
    colors: {
      ...theme.colors,
