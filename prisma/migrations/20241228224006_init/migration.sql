...
CREATE TABLE "SkyCloud" (
    ...
    "websiteTitle" TEXT NOT NULL DEFAULT 'SkyCloud',
    "websiteTitleLogo" TEXT,
    "websiteExternalLinks" JSONB NOT NULL DEFAULT '[{ "name": "GitHub", "url": "https://github.com/diced/skycloud"}, { "name": "Documentation", "url": "https://skycloud.diced.sh/"}]',
    ...
    "mfaTotpIssuer" TEXT NOT NULL DEFAULT 'SkyCloud',
    ...
    "pwaTitle" TEXT NOT NULL DEFAULT 'SkyCloud',
    "pwaShortName" TEXT NOT NULL DEFAULT 'SkyCloud',
    "pwaDescription" TEXT NOT NULL DEFAULT 'SkyCloud',
    "pwaThemeColor" TEXT NOT NULL DEFAULT '#000000',
    "pwaBackgroundColor" TEXT NOT NULL DEFAULT '#000000',

    CONSTRAINT "SkyCloud_pkey" PRIMARY KEY ("id")
);
